...
Item
{
    ...
    {
        petStage.GetTeam(teamIndex).GetPet(0).AddAura(246, 3, false, teamIndex, petStage.GetTeam(teamIndex).ActivePetIndex, petStage.GetTeam(teamIndex).ActivePet.Power);
