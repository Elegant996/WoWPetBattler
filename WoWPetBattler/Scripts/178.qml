...
Item
{
                        ...
                        isHitting, isCritting, isProcing)
    {
        ...
        if (!isAvoiding && isHitting)
        {
            ...
            petHelper.CheckCleansingRain(petStage, (teamIndex%2)+1, petStage.GetTeam((teamIndex%2)+1).ActivePetIndex, 177, 4, true, petStage.GetTeam(teamIndex).ActivePet.Power);
