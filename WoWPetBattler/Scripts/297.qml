...
Item
{
                        ...
                        isHitting, isCritting, isProcing)
    {
        ...
        if (!petStage.GetTeam(teamIndex).ActivePet.HasAura(296))
        {
            petStage.GetTeam(teamIndex).ActivePet.AddAura(296, -1, true);
            return 0;
        }
        ...
        petStage.GetTeam(teamIndex).ActivePet.RemoveAuraId(296);
