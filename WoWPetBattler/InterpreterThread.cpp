...
InterpreterThread::InterpreterThread(PetStage* petStage) :
	BUILD(56), running(false)
{
	this->petStage = petStage;
}


InterpreterThread::~InterpreterThread(void)
{
	delete[] pixels;
	delete[] points;
	delete image;
